...
class CodonStateSpace : public StateSpace	{
	...
	*/
	...
	bool ConsPolVol(int codon1, int codon2) {
		return (PolTable[CodonCode[codon1]] == PolTable[CodonCode[codon2]] && VolTable[CodonCode[codon1]] == VolTable[CodonCode[codon2]]);
	}

	bool ConChr(int codon1, int codon2) {
		return (ChrTable[CodonCode[codon1]] == ChrTable[CodonCode[codon2]]);
	}
